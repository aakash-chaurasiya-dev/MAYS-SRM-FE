...
export const ROUTE_CONFIG = {
  ...
  '/inventory/products': { title: 'Product List', icon: <Inventory2OutlinedIcon fontSize="small" />, isClosable: true },
  '/inventory/prices': { title: 'Part Prices', icon: <Inventory2OutlinedIcon fontSize="small" />, isClosable: true },
  '/inventory/in-stock': { title: 'In-Stock Parts', icon: <Inventory2OutlinedIcon fontSize="small" />, isClosable: true },
  '/inventory/ticket-parts': { title: 'Ticket Parts', icon: <Inventory2OutlinedIcon fontSize="small" />, isClosable: true },
  '/inventory/orders': { title: 'Parts Orders', icon: <Inventory2OutlinedIcon fontSize="small" />, isClosable: true },
  '/inventory/orders/:orderId': { title: (params) => `Parts Order #${params.orderId}`, icon: <Inventory2OutlinedIcon fontSize="small" />, isClosable: true },
  ...
  '/enquiries/:id': { title: (params) => `Enquiry Profile #${params.id}`, icon: <BadgeOutlinedIcon fontSize="small" />, isClosable: true },
  '/enquiries/new': { title: 'New Enquiry', icon: <AddIcon fontSize="small" />, isClosable: true },
  '/enquiries': { title: 'Enquiries', icon: <BadgeOutlinedIcon fontSize="small" />, isClosable: true },
