...
import { Box, Dialog, DialogTitle, DialogContent, DialogActions, TextField, CircularProgress, Button, Divider, Typography, MenuItem, InputAdornment } from '@mui/material';
...
export default function ServiceChargesManagementPage() {
  ...
  }), [serviceCharges, clearSelectionKey, selectedIds, selectedRowsAreLocked]);
